...
<table width="100%" border="0" align="center" cellspacing="3" cellpadding="3" bgcolor="#FFFFFF">
  ...
  <tr> 
    <td valign="top" nowrap> 
      ...
      <table class="list_table" width="100%" border="1" cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" bordercolorlight="#CCCCCC">
        <tr bgcolor="#799AE1"> 
          <td width="4%"> 
...
%>
        <tr> 
          ...
          <td> 
            <div align='center'><a href="add.asp?id=<%=rs("id")%>" class="tt2">修改</a></div>
          </td>
        </tr>
        <%
		rs.movenext						
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
        <form name="pageform" method=get action="list.asp">
          <tr>
            ...
            <td width="30%">全部选中 <input name="delbtn" value=" 删 除 " type="button" class="button2" style="margin-left:20px;" onClick="cdel();"/>
            <a href="add.asp" name="addbtn" class="button3" style="display:inline-block;margin-left:20px;" > 新添加一条Event </a>
            </td>
            <td>
              <div align="right">跳到第 
